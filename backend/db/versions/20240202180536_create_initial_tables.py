...
def upgrade() -> None:
    ...
    op.create_table('squads_applies',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_squads_applies_id'), 'squads_applies', ['id'], unique=False)
    op.create_table('squads_invitations',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('squad_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['squad_id'], ['squads.id'], ondelete='CASCADE'),
    ...
    op.create_index(op.f('ix_squads_invitations_id'), 'squads_invitations', ['id'], unique=False)
    op.create_table('squads_members',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('squad_id', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_squads_members_id'), 'squads_members', ['id'], unique=False)
    op.create_table('squads_photos',
    sa.Column('squad_id', sa.Integer(), nullable=True),
    sa.Column('file_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['file_id'], ['files.id'], ),
